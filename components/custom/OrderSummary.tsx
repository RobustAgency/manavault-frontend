...
export const OrderSummaryCard = ({ type, order }: OrderSummaryCardProps) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Financial details of this {type} order</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {'updated_at' in order &&  order?.updated_at && (
            <div>
